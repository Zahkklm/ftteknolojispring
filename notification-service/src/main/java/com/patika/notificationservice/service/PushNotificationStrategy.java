...
public class PushNotificationStrategy implements NotificationStrategy {
    ...
    public PushNotificationStrategy(NotificationProducer notificationProducer, NotificationRepository notificationRepository) {
        this.notificationProducer = notificationProducer;
        this.notificationRepository = notificationRepository;
    }
    @Override
    public void sendNotification(NotificationRequest notificationRequest) {
        System.out.println("PUSH bildirimi gönderilen kişi: " + notificationRequest.getRecipient() + " içerik: " + notificationRequest.getMessage());
        try {
